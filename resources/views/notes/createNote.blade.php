...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('note.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                        ...
                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <a href="{{ route('notes.index') }}" class="btn btn-sm btn-rose">{{ __('Retour') }}</a>
                                </div>
                            </div>
                            <div class="row">
